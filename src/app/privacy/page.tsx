          ...
          <div className="prose prose-lg max-w-none space-y-10 text-gray-700 leading-relaxed">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 mr-4">
                ...
                <li>تشغيل ميزات الذكاء الاصطناعي مستقبلاً (التصنيف الذكي للمعاملات) عند إطلاقها</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p>
                نتخذ تدابير أمنية لحماية بياناتك المالية والشخصية تشمل:
              </p>
              <ul className="list-disc list-inside space-y-2 mr-4 mt-3">
                ...
                <li>استضافة عبر شبكة Cloudflare العالمية مع نقاط تواجد (Edge Nodes) في دولة الإمارات لضمان سرعة الوصول وسيادة البيانات أثناء النقل</li>
              </ul>
            </div>

            {/* Data Processing Jurisdiction */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">نطاق معالجة البيانات</h2>
              <p>
                تتم معالجة بياناتك وفقاً لأحكام المرسوم بقانون اتحادي رقم (45) لسنة 2021 بشأن حماية البيانات الشخصية (PDPL). تلتزم المنصة بمعالجة البيانات ضمن نطاق الاختصاص القضائي لدولة الإمارات العربية المتحدة، مع مراعاة متطلبات نقل البيانات عبر الحدود المنصوص عليها في القانون عند الضرورة التقنية.
              </p>
              <p className="mt-3">
                يقع المقر الرئيسي للشركة في إمارة أبوظبي، وتخضع جميع عمليات معالجة البيانات للقوانين الاتحادية المعمول بها في الدولة.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 mr-4 mt-3">
                ...
                <li>مع مزودي الخدمات الفنية (الاستضافة، المصادقة) بموجب اتفاقيات سرية</li>
                <li>مع مزودي خدمات الذكاء الاصطناعي لمعالجة البيانات وفقاً لاتفاقيات حماية البيانات (عند تفعيل ميزات الذكاء الاصطناعي مستقبلاً)</li>
            ...
            <div>
              ...
              <p>
                نستخدم ملفات تعريف الارتباط الضرورية لتشغيل المنصة وتأمين جلسات المستخدمين. قد نستخدم أيضاً ملفات تعريف ارتباط تحليلية لفهم كيفية استخدام المنصة وتحسينها. يمكنك التحكم في إعدادات ملفات تعريف الارتباط من خلال متصفحك أو من خلال إشعار ملفات تعريف الارتباط عند زيارة الموقع.
              </p>
            </div>
