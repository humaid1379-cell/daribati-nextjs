        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none space-y-10 text-gray-700 leading-relaxed">
            ...
            <div>
              ...
              <p>
                تلتزم مؤسسة ضريباتي لاستشارات تقنية المعلومات (&ldquo;ضريبتي&rdquo; أو &ldquo;نحن&rdquo;) بحماية خصوصية مستخدمي منصتنا. توضح سياسة الخصوصية هذه كيفية جمع واستخدام وتخزين وحماية المعلومات الشخصية والمالية التي تقدمها عند استخدام منصة ضريبتي لإدارة الضرائب والفوترة.
              </p>
              <p>
