          ...
          <div className="prose prose-lg max-w-none space-y-10 text-gray-700 leading-relaxed">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 mr-4">
                ...
                <li>تشغيل ميزات الذكاء الاصطناعي (التصنيف الذكي للمعاملات)</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 mr-4 mt-3">
                <li>تشفير البيانات أثناء النقل باستخدام بروتوكول TLS</li>
                ...
                <li>استضافة عبر بنية تحتية سحابية موثوقة</li>
              </ul>
            </div>
