...
export default function TermsPage() {
  ...
  const lastUpdated = "21 مايو 2026";
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none space-y-10 text-gray-700 leading-relaxed">
            ...
            <div>
              ...
              <p>
                توفر منصة ضريبتي خدمات برمجية سحابية (SaaS) لإدارة الضرائب والفوترة تشمل (حسب الباقة المختارة):
              </p>
              <ul className="list-disc list-inside space-y-2 mr-4 mt-3">
                ...
                <li>استيراد البيانات المالية من ملفات CSV</li>
                <li>تصنيف ذكي للمعاملات باستخدام الذكاء الاصطناعي (قريباً)</li>
                <li>مساعد ضريبي ذكي للإجابة على الاستفسارات — باقة المؤسسات (قريباً)</li>
                <li>إعداد التقارير الضريبية الدورية</li>
              </ul>
              <p className="mt-3 text-sm text-gray-500">
                قد تختلف الميزات المتاحة حسب الباقة المختارة. يُرجى مراجعة صفحة الأسعار للاطلاع على تفاصيل كل باقة.
              </p>
            </div>
            ...
            {/* Free Trial */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">الفترة التجريبية المجانية</h2>
              <p>
                نوفر فترة تجريبية مجانية لمدة 14 يوماً لجميع الباقات. خلال هذه الفترة:
              </p>
              <ul className="list-disc list-inside space-y-2 mr-4 mt-3">
                <li>يمكنك الوصول إلى جميع ميزات الباقة المختارة</li>
                <li>لا يُطلب إدخال بيانات الدفع خلال الفترة التجريبية</li>
                <li>ينتهي الاشتراك تلقائياً بعد 14 يوماً ما لم تختر الاشتراك المدفوع</li>
                <li>لا يتم تحصيل أي رسوم خلال الفترة التجريبية</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 mr-4 mt-3">
                ...
                <li>جميع الأسعار لا تشمل ضريبة القيمة المضافة (5%) ما لم يُذكر خلاف ذلك</li>
              </ul>
            </div>
            ...
            {/* AI Features */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">ميزات الذكاء الاصطناعي (قيد التطوير)</h2>
              <p>
                تخطط المنصة لاستخدام تقنيات الذكاء الاصطناعي لتصنيف المعاملات والإجابة على الاستفسارات الضريبية في مراحل لاحقة. عند تفعيل هذه الميزات، يُرجى ملاحظة أن:
              </p>
              <ul className="list-disc list-inside space-y-2 mr-4 mt-3">
            ...
            <div>
              ...
              <p>
                يمكنك إلغاء اشتراكك في أي وقت عبر التواصل معنا على البريد الإلكتروني. يحق لنا إنهاء أو تعليق حسابك فوراً في حالة:
              </p>
              <ul className="list-disc list-inside space-y-2 mr-4 mt-3">
            ...
            <div>
              ...
              <p>
                تخضع هذه الشروط لقوانين دولة الإمارات العربية المتحدة وتُفسر وفقاً لها. أي نزاع ينشأ عن هذه الشروط أو يتعلق بها يخضع للاختصاص الحصري لمحاكم إمارة أبوظبي، الإمارات العربية المتحدة.
              </p>
            </div>

            {/* Force Majeure */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">القوة القاهرة</h2>
              <p>
                لا يُعد أي طرف مسؤولاً عن أي تأخير أو إخفاق في تنفيذ التزاماته بموجب هذه الشروط إذا كان ذلك ناتجاً عن ظروف خارجة عن سيطرته المعقولة، بما في ذلك على سبيل المثال لا الحصر: الكوارث الطبيعية، الأوبئة، الحروب، الإرهاب، الإضرابات، القرارات الحكومية، انقطاع الاتصالات، أو أعطال البنية التحتية التقنية الخارجية.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="mt-4 p-6 bg-gray-50 rounded-xl border border-gray-100">
                ...
                <p className="mt-1">أبوظبي، الإمارات العربية المتحدة</p>
              </div>
            </div>
