...
export default function TermsPage() {
  ...
  const lastUpdated = "18 مايو 2025";
          ...
          <div className="prose prose-lg max-w-none space-y-10 text-gray-700 leading-relaxed">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 mr-4 mt-3">
                ...
                <li>مساعد ضريبي ذكي للإجابة على الاستفسارات (باقة المؤسسات)</li>
            ...
            <div>
              ...
              <p>
                تخضع هذه الشروط لقوانين دولة الإمارات العربية المتحدة وتُفسر وفقاً لها. أي نزاع ينشأ عن هذه الشروط أو يتعلق بها يخضع للاختصاص الحصري لمحاكم دبي، الإمارات العربية المتحدة.
              </p>
            </div>
