...
const complianceTopics = [
  {
    ...
    items: [
      ...
      "إصدار فواتير ضريبية متوافقة مع متطلبات FTA",
  ...
  },
  {
    ...
    descAr:
      "تفرض الهيئة الاتحادية للضرائب غرامات على المخالفات الضريبية. من المهم الالتزام بالمواعيد والمتطلبات لتجنب العقوبات المالية.",
    items: [
      "غرامة التأخر في التسجيل: 20,000 درهم",
      "غرامة التأخر في تقديم الإقرار: 1,000 - 2,000 درهم",
      "غرامة التأخر في السداد: 2% - 4% من المبلغ المستحق",
      "غرامة عدم الاحتفاظ بالسجلات: 10,000 - 20,000 درهم",
      "غرامة تقديم بيانات غير صحيحة: تصل إلى 50,000 درهم",
    ],
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-blue-100 mb-8">
            ضريبتي يساعدك على البقاء متوافقاً مع جميع المتطلبات الضريبية
            تلقائياً.
          </p>
